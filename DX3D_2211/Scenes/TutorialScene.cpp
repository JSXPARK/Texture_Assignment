...
TutorialScene::TutorialScene()
{
	...
	vertices.emplace_back(-0.5f, -0.5f, 0, 1, 0, 0);
	vertices.emplace_back(+0.5f, +0.5f, 0, 0, 1, 0);	
	vertices.emplace_back(+0.5f, -0.5f, 0, 0, 0, 1);	
	vertices.emplace_back(-0.5f, +0.5f, 0, 1, 1, 0);
